...
<body style="word-spacing:normal;background-color:#1f1f1f;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:200px;">
                                <img height="auto" src="https://api.escueladebajistas.com/mail/img/logo-white.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#ffffff;">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam cumque error pariatur incidunt inventore ab repellat, autem corrupti iusto voluptatum nisi nobis quod quis doloribus accusamus beatae animi dolorem repellendus?</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
EOT,
    ...
    public function can_use_mailable_in_mail_helper()
    {
        ...
        Mail::to('staff@example.com')->send($mailable);
